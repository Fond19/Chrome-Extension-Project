...
// @version      0.1
// @description  try to take over the world muahahahah!
// @author       You
// @match        *://*/*
// @grant        none
// ==/UserScript==
...
var chuck = ["https://i.pinimg.com/236x/fc/9e/0a/fc9e0a256d27375e2eaa805504d6fcf1--chuck-norris-facts-chuck-norris-funny.jpg",
            ...
            "https://www.lifewire.com/thmb/dp3FT0kShwtnfL6YJVUkozAbsJk=/1063x650/filters:no_upscale():max_bytes(150000):strip_icc()/chucknorrisgrandcanyon-5ac2b512a18d9e00372a7ac7.JPG",
            "https://images-cdn.9gag.com/photo/aLDQDmA_700b.jpg"];
...
var bean = ["https://media1.tenor.com/images/4858f43f53f0ae4cc4d9f48ef06ff002/tenor.gif",
            ...
            "https://media1.giphy.com/media/O1UIywepuHaF2/giphy.gif",
            "http://gif-finder.com/wp-content/uploads/2015/03/Mr.Bean-Middle-Finger.gif",
            "https://i.pinimg.com/originals/e2/97/ff/e297ff79b71a5873f6b175d1f76184cd.gif"
            ];
...
var queen = ['https://www.ibtimes.com.au/sites/au.ibtimes.com/files/styles/v2_article_large/public/2017/12/14/britains-queen-elizabeth.jpg?itok=vn-QfazG',
            'https://i0.wp.com/royalcentral.co.uk/wp-content/uploads/2018/03/Queen_Elizabeth_II_March_2015_by_Joel_Rouse_MoD.jpg?resize=1000%2C600',
            'https://the-hollywood-gossip-res.cloudinary.com/iu/s--7Um8v4_O--/c_scale,f_auto,h_825,q_auto,w_696/v1364527892/queen-elizabeth-picture',
            'https://cdn.newsapi.com.au/image/v1/cfc4777469b981e59ffe9fcf70b1391f',
            'https://metrouk2.files.wordpress.com/2018/06/gettyimages-966426952.jpg?quality=90&strip=all&zoom=1&resize=644%2C474',
            'http://1.bp.blogspot.com/_XBcVB7CTPCM/TOzRzidLz5I/AAAAAAAADx0/EJUWvYdvidE/s320/Her+majesty+the+queen.jpg',
            'https://secure.i.telegraph.co.uk/multimedia/archive/03273/HM-Queen-Elizabeth_3273772b.jpg',
            'https://hopelesshannahdotcom.files.wordpress.com/2016/04/liz1.jpg',
            'http://s2.thingpic.com/images/GQ/k3YmRf42zzM1amKLLxqL48sr.gif',
            'https://img-s-msn-com.akamaized.net/tenant/amp/entityid/AAydayj.img?h=1080&w=1920&m=6&q=60&o=f&l=f&x=499&y=792',
            'https://pbs.twimg.com/media/DN9C742X0AANAmu.jpg'];

var terry = ['https://media.giphy.com/media/3o6gaSgLGfCWdCrlCg/giphy.gif',
            'https://media.giphy.com/media/lnZMwPcmCzX4k/giphy.gif',
            'https://media1.tenor.com/images/561160322c187f7233c20b570c07737d/tenor.gif?itemid=4754376',
            'https://media.giphy.com/media/EUxkZPmTfB7Fe/giphy.gif',
            'https://media.tenor.com/images/64635fd1424cddbaf46e6a838c1faa19/tenor.gif',
            'https://media.giphy.com/media/3o7WTKVCEFABGgXois/giphy.gif',
            'https://media.giphy.com/media/8v4gHHMcL9756/200.gif',
            'https://i.makeagif.com/media/12-16-2013/BhspHV.gif']


var imgs = document.getElementsByTagName("img");
for(var i=0, l=imgs.length; i<l; i++) {
    var random = Math.floor(Math.random() * (4 - 0 + 1));
    imgs[i].src = funny[random];
}
